import {
  ...
  const achievements = [
    {
      title: "Certificado de Inglés B2 Growing School|IB.",
    },
    {
      title: "Certificación Google e INCIBE frente a la ciberseguridad en el teletrabajo.",
    },
    {
      title: "Seleccionado entre los 100 mejores candidatos para  Google e INCIBE.",
    },
    {
      title: "Publicación: Exploración de la Percepción de los Docentes respecto al Uso de la Plataforma Moodle: Un Análisis de Satisfacción.",
    },
    {
      title: "Fundador del Grupo de Baile Folklorico Sangre Caliente.",
    },
    {
      title: "• Certificado de Capacitación y Gestión del emprendimiento Universidad central del Ecuador.",
    },
  ]
  ...
  const experiences = [
    {
      ...
      link: "",
      points: [
        "Me gradue con un titulo Internacional de Bachiller",
        "Comprendo el idioma inglés nivel b2 y Speaking: Intermedio",
        "Realicé procesos de Ayuda comunitaria",
        "Aprendizaje del Idioma Italiano nivel:Intermedio",
      ],
      link: "https://drive.google.com/drive/folders/13FK-YewFDv8ALmzKglPBmb6Z3oenuYoP",
    },
    {
      title: "Pasantia en TIC",
      company_name: "PETROCOMERCIAL",
      ...
      link: "",
      points: [
        "He realizado pasantias en PETROCOMERCIAL una de las empresas mas reconocidas en Ecuador",
        "Trabaje en el Área de TIC's (Teconologías de la Información y la Comunicación), en el area de redes e infraestructura",
        "Realicé procesos de infraestructura en la empresa trabajando en  proyectos como Anthenas localizado en el los Andes.",
        "Trabaje en el proyecto protoipo de desarrolo y manejo de Antenas",
      ],
      link: "https://github.com/codewithrathi",
    },
    {
      title: "INTERNO en ARCRNNR",
      company_name: " AGENCIA DE REGULACIÓN Y CONTROL DE ENERGÍA Y RECURSOS NATURALES NO RENOVABLES (Interno)",
      icon: "https://img.icons8.com/color/344/GeeksforGeeks.png",
      iconBg: "#E6DEDD",
      date: "May 2024 - Jun 2024",
      link: "",
      points: [
        "Trabaje como interno en la institucion pública en el Area de TI",
        "Estuve a cargo de el Monitorieo de la infraestructura empresarial y la administracion de Base de datos como aprendiz",
      ],
      link: "https://drive.google.com/drive/folders/1efpnfKpRTvtujtSgHwRIJdrMFiWrBFHt",
    },
    {
      title: "PAPERS ACADÉMICOS",
      company_name: "GeeksforGeeks ESPE",
      icon: "https://img.icons8.com/color/344/GeeksforGeeks.png",
      iconBg: "#383E56",
      date: "Dec 2021 - May 2022",
      link: "",
      points: [
        "Desarrollo de Paper Academico y de investigacion",
        "Titulo: Exploración de la percepci[on de los docentes respecto al uso de la plataforma Moodle: Un analisís de Satisfacción",
        "Autores: Toapanta Jonathan, Mogrovejo Sebastian, Andrango Jessica",
      ],
      link: "https://auth.geeksforgeeks.org/user/_shinchancode",
    },
    {
      title: "Google and INCIBE Training",
      ...
      link: "",
      points: [
        "Aprendizaje  del conocimiento en Google Cloud Platform (GCP) en conjunto con INCIBE",
        "Protege tu Negocio: Ciberseguridad en el Teletrabajo.",
        "Un programa de Innovación en Ciberseguridad de la PYME impulsado por la Secretaría General de Industria y de la PYME (SGIPYME) del Ministerio de Industria, Comercio y Turismo y gestionado por EOI.",
      ],
    ...
    },
    {
      ...
      link: "",
      points: [
        "Certificación de Capacitación y Gestión del Emprendimiento Universidad central del Ecuador.",
        "En reconocimiento a la participación en una conferencia sobre emprendimiento",
        "Conocimientos sobre estrategias de negocio y desarrollo de productos.",
      ],
      link: "https://dev.to/shinchancode",
    },
  ];
  ...
  const educations = [
    ...
    },
    {
      degree:
        "Colegio",
      branch : "Bachilletaro Tecnico|B",
      marks:
        "Balichiller: Electronico",
    ...
    },
    {
      degree:
        "Universidad",
      branch: "En proceso jeje",
      marks:
        "Carrera: Ingenieria TI",
