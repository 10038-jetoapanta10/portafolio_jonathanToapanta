  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "JOnathan Toapanta",
          from_email: form.email,
          to_email: "trabajoct@goutlook.com",
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:aarti.rathi1710@gmail.com" target="_blank" className="blue-text-gradient">trabajoct@outlook.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
